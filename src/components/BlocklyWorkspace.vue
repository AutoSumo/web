        ...
        <xml xmlns="https://developers.google.com/blockly/xml" ref="toolbox" style="display: none">
            ...
            <category name="Loops" colour="#5ba55b">
                ...
                <block type="controls_for">
                    <field name="VAR" id="rn74zANh2EfK*/jRHzS_">i</field>
                    <value name="FROM">
                        <shadow type="math_number">
                ...
                <block type="controls_forEach">
                    <field name="VAR" id="R}90MEJ5$a}dDXZ)QReg">j</field>
                </block>
            ...
            <category name="Text" colour="#5ba58c">
                ...
                <block type="text_append">
                    <field name="VAR" id="Swd2CoXp6uG~vA*?$W^3">item</field>
                    <value name="TEXT">
                        <shadow type="text">
                            <field name="TEXT"></field>
                        </shadow>
                ...
                <block type="text_indexOf">
                    ...
                    <value name="VALUE">
                        <block type="variables_get">
                            <field name="VAR" id="/Pi![Jg0zE}8==N*WVH;">text</field>
                        </block>
                    </value>
                    <value name="FIND">
                        <shadow type="text">
            ...
            <category name="Lists" colour="#745ba5">
                ...
                <block type="lists_indexOf">
                    ...
                    <value name="VALUE">
                        <block type="variables_get">
                            <field name="VAR" id="MU%9/=7h)Ljd]FMIz2|_">list</field>
                        </block>
                    </value>
                </block>
            ...
            <sep></sep>
            <category name="Robot" colour="#5ba55b">
                <block type="move_motors"></block>
                <block type="lidar_value"></block>
                <block type="ir">
